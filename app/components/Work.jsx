         ...
         className='grid grid-cols-auto lg:grid-cols-4 my-10 gap-5'>
            {workData.map((project, index)=>(
                ...
                style={{backgroundImage: `url(${project.bgImage})`}}>
                    ...
                    justify-between duration-500 group-hover:bottom-7 min-h-[110px]'>
                      <div>
                    ...
                    <div
                       ...
                       shadow-[2px_2px_0_0_#000] group-hover:bg-lime-300 hover:scale-105 active:scale-95 active:translate-y-[2px] 
           ...
           font-Ovo mb-[-30]'>Click the the link below to see the live demo projects</p>
         <motion.a 
          initial={{ opacity: 0}}
          whileInView={{ opacity: 1}}
          ...
          mx-auto my-20 hover:bg-lightHover hover:scale-105 active:scale-95 active:translate-y-[2px]
          transition duration-200 ease-in-out'>
