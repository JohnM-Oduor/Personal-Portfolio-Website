...
const Header = () => {
  return (
    ...
    items-center justify-center gap-4'>
     ...
     >
      <Image src={assets.profile_img} alt='' className='rounded-full w-28 ml-0 mt-45 mb-[-30]' />
     </motion.div>
    <motion.h3 
    ...
    className='flex items-end gap-2 text-xl md:text-2xl mb-3 mt-10 ml-10 font-Ovo'>
          👋 Hi! I'm John Oduor </motion.h3>
